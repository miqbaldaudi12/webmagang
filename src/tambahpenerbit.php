...
<head>
  ...
  <title>Pendataan Magang - Tambah Mentor</title>
    ...
    <div class="card">
      <div class="card-header">
        <h5 class="card-title mb-0">
          <i class="bi bi-person-plus-fill"></i> Tambah Mentor
        </h5>
      </div>
      <div class="card-body">
        <form action="query/tambahpenerbit.php" method="post">
          <div class="row g-3">
            <div class="col-12">
              <div class="mb-3">
            ...
            <div class="col-md-6">
              <div class="mb-3">
                ...
                <input type="email" class="form-control" id="email_mentor" name="email_mentor" required>
              </div>
            </div>
            <div class="col-md-6">
              <div class="mb-3">
            ...
            <div class="col-12">
              <div class="mb-3">
                ...
                <textarea class="form-control" id="alamat_mentor" name="alamat_mentor" rows="2" required></textarea>
              </div>
            </div>
            <div class="col-12">
